            ...
            if eventid in EVENT_ID or eventid in sigma_eventids:
                ...
                ###
                    ...
                    if username != "-" and username != "anonymous logon" and ipaddress != "::1" and ipaddress != "127.0.0.1" and (ipaddress != "-" or hostname != "-"):
                        ...
                        event_set = event_set._append(event_series, ignore_index=True)
                        ml_frame = ml_frame._append(ml_series, ignore_index=True)
                        ...
                        count_set = count_set._append(count_series, ignore_index=True)
